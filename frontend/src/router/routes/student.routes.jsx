...
export const StudentRoutes = (
  <>
    ...
    <Route path="/assessments/marksheet" element={<MarksheetPage role="student" />} />
    <Route path="/assessments/transcript" element={<TranscriptPage role="student" />} />
    <Route path="/timetables" element={<TimetablePage role="student" />} />
