...
import { ArrowLeft, Plus, FileX, LoaderCircle, AlertTriangle, Search } from "lucide-react";
  ...
  return (
    <section className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-[20px] font-semibold tracking-[-0.01em] text-slate-950">Issue Invoice</h1>
          <p className="text-[13px] text-slate-500">Issue and reverse invoices</p>
        </div>
      </div>
...
function AdmissionNumberLookup({ studentsApi, accountApi, onStudentReady }) {
